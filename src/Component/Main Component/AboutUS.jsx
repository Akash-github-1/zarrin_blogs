...
//               <div className='py-4 '>
//                  <Headings type='h6'className='text-center opacity-65'>ABOUT US</Headings> 
//                  <Headings type='h2'className='text-center item-center py-4'>Creative Blog Writting and publishing site</Headings>
//                       <div className='flex justify-center'>
//                          <Paragraph variant='small' className='text-center  opacity-65 py-4  px-36 '>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.</Paragraph>
//                       </div>
//                       <div className='flex justify-center py-24'>
//                          <Image src={'/Assets/group.png'} alt={'group'} className=' h-custom-x w-custom  '/>
//                       </div>
//               </div>
//               <div className='py-12'>
...
//                 <div>
//                   <Headings type='h3' >I will show you how our team works</Headings>
//                 </div>
//                 <div>
//                   <Paragraph variant='small' className='bottom-0 right-0 opacity-70 h-4vh'>Bring to the table win-win market strategies to ensure perfect articles. </Paragraph>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//             <Paragraph
//               variant='small'
//               className='text-center opacity-65 py-4 max-w-xl'
//             >
